let pretty_program p = 
  ...
  |> Option.map Conceptual.Pretty.program_to_tree
...
let (!>) p =  ~/p |> pretty_program |> print_endline


let %expect_test "Testing Util Works" = 
  print_endline @@ if Sys.file_exists (~/"reservation") then "exists" else "does not exist";
  [%expect {| exists |}]
...
let %expect_test "Reservation Concept" =
  ...
  [%expect {| 
    ...
    │   │ │ │ └─[36mBinOp[0m
    │   │ │ │   ├─[36mLval[0m
    │   │ │ │   │ └─[36mVar([0m[33mr[0m[36m)[0m
    │   │ │ │   ├─[34mNotIn[0m
    │   │ │ │   └─[36mLval[0m
    │   │ │ │     └─[36mVar([0m[33mreservations[0m[36m)[0m
    │   │ │ └─[36mBody[0m
    │   │ │   └─[36mStatements[0m
    │   │ │     └─[36mAssignment[0m
    │   │ │       ├─[36mVar([0m[33mavailable[0m[36m)[0m
    │   │ │       └─[36mBinOp[0m
    │   │ │         ├─[36mLval[0m
    │   │ │         │ └─[36mVar([0m[33mavailable[0m[36m)[0m
    │   │ │         ├─[34mPlus[0m
...
let %expect_test "Trash Concept" = 
  ...
  [%expect {|
    ...
    │   │ │ │   └─[36mBinOp[0m
    │   │ │ │     ├─[36mLval[0m
    │   │ │ │     │ └─[36mVar([0m[33maccessible[0m[36m)[0m
    │   │ │ │     ├─[34mPlus[0m
    │   │ │ │     └─[36mLval[0m
    │   │ │ │       └─[36mVar([0m[33mtrashed[0m[36m)[0m
    │   │ │ └─[36mBody[0m
    │   │ │   └─[36mStatements[0m
    │   │ │     └─[36mAssignment[0m
    │   │ │       ├─[36mVar([0m[33maccessible[0m[36m)[0m
...
let %expect_test "Email Concept" = 
  ...
  [%expect {|
    ...
    │   │ │ │ └─[36mBinOp[0m
    │   │ │ │   ├─[36mLval[0m
    │   │ │ │   │ └─[36mVar([0m[33mm[0m[36m)[0m
    │   │ │ │   ├─[34mNotIn[0m
    │   │ │ │   └─[36mBinOp[0m
    │   │ │ │     ├─[36mLval[0m
    │   │ │ │     │ └─[36mVar([0m[33m_for[0m[36m)[0m
    │   │ │ │     ├─[34mJoin[0m
    │   │ │ │     └─[36mLval[0m
    │   │ │ │       └─[36mVar([0m[33minbox[0m[36m)[0m
    │   │ │ └─[36mBody[0m
    │   │ │   └─[36mStatements[0m
    │   │ │     ├─[36mAssignment[0m
    │   │ │     │ ├─[36mRelation[0m
    │   │ │     │ │ ├─[36mVar([0m[33mm[0m[36m)[0m
    │   │ │     │ │ └─[36mVar([0m[33mcontent[0m[36m)[0m
    │   │ │     │ └─[36mLval[0m
    │   │ │     │   └─[36mVar([0m[33mc[0m[36m)[0m
    │   │ │     ├─[36mAssignment[0m
    │   │ │     │ ├─[36mRelation[0m
    │   │ │     │ │ ├─[36mVar([0m[33mm[0m[36m)[0m
    │   │ │     │ │ └─[36mVar([0m[33mfrom[0m[36m)[0m
    │   │ │     │ └─[36mLval[0m
    │   │ │     │   └─[36mVar([0m[33mby[0m[36m)[0m
    │   │ │     └─[36mAssignment[0m
    │   │ │       ├─[36mRelation[0m
    │   │ │       │ ├─[36mVar([0m[33mm[0m[36m)[0m
    │   │ │       │ └─[36mVar([0m[33mto[0m[36m)[0m
    │   │ │       └─[36mLval[0m
    │   │ │         └─[36mVar([0m[33m_for[0m[36m)[0m
    │   │ ├─[36mAction[0m
    ...
    │         │ └─[36mArguments[0m
    │         │   ├─[36mLval[0m
    │         │   │ └─[36mVar([0m[33mf[0m[36m)[0m
    │         │   ├─[36mLval[0m
    │         │   │ └─[36mVar([0m[33mt[0m[36m)[0m
    │         │   ├─[36mLval[0m
    │         │   │ └─[36mVar([0m[33mm[0m[36m)[0m
    │         │   └─[36mLval[0m
    │         │     └─[36mVar([0m[33mc[0m[36m)[0m
...
let %expect_test "Label Concept" =
  ...
  [%expect {|
    ...
    │   │ │     └─[36mAssignment[0m
    │   │ │       ├─[36mRelation[0m
    │   │ │       │ ├─[36mVar([0m[33mi[0m[36m)[0m
    │   │ │       │ └─[36mVar([0m[33mlabels[0m[36m)[0m
    │   │ │       └─[36mBinOp[0m
    │   │ │         ├─[36mLval[0m
    │   │ │         │ └─[36mRelation[0m
    │   │ │         │   ├─[36mVar([0m[33mi[0m[36m)[0m
...
let %expect_test "Style Concept" = 
  ...
  [%expect {|
    ...
    │   │     └─[36mBinOp[0m
    │   │       ├─[36mLval[0m
    │   │       │ └─[36mVar([0m[33massigned[0m[36m)[0m
    │   │       ├─[34mJoin[0m
    │   │       └─[36mLval[0m
    │   │         └─[36mVar([0m[33mdefined[0m[36m)[0m
    │   ├─[36mActions[0m
    │   │ ├─[36mAction[0m
    ...
    │   │ │     └─[36mAssignment[0m
    │   │ │       ├─[36mRelation[0m
    │   │ │       │ ├─[36mVar([0m[33me[0m[36m)[0m
    │   │ │       │ └─[36mVar([0m[33massigned[0m[36m)[0m
    │   │ │       └─[36mLval[0m
    │   │ │         └─[36mVar([0m[33ms[0m[36m)[0m
    │   │ └─[36mAction[0m
...
let %expect_test "Todo Concept" = 
  ...
  [%expect {|
    ...
    │   │ │ │   └─[36mBinOp[0m
    │   │ │ │     ├─[36mLval[0m
    │   │ │ │     │ └─[36mVar([0m[33mdone[0m[36m)[0m
    │   │ │ │     ├─[34mPlus[0m
    │   │ │ │     └─[36mLval[0m
    │   │ │ │       └─[36mVar([0m[33mpending[0m[36m)[0m
    │   │ │ └─[36mBody[0m
    │   │ │   └─[36mStatements[0m
    │   │ │     └─[36mAssignment[0m
    │   │ │       ├─[36mVar([0m[33mpending[0m[36m)[0m
...
let %expect_test "Upvote Concept" = 
  ...
  [%expect {|
    ...
    │   │ │ │     ├─[34mJoin[0m
    │   │ │ │     └─[36mLval[0m
    │   │ │ │       └─[36mVar([0m[33mupvotes[0m[36m)[0m
    │   │ │ └─[36mBody[0m
    │   │ │   └─[36mStatements[0m
    │   │ │     ├─[36mAssignment[0m
    │   │ │     │ ├─[36mRelation[0m
    ...
    │   │ │       ├─[36mRelation[0m
    │   │ │       │ ├─[36mVar([0m[33mi[0m[36m)[0m
    │   │ │       │ └─[36mVar([0m[33mdownvotes[0m[36m)[0m
    │   │ │       └─[36mBinOp[0m
    │   │ │         ├─[36mLval[0m
    │   │ │         │ └─[36mRelation[0m
    │   │ │         │   ├─[36mVar([0m[33mi[0m[36m)[0m
